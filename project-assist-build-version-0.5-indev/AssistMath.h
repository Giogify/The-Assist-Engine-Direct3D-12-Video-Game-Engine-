...
namespace AssistMath {
	...
	constexpr uint32_t AM_PERMUTE_0X = 0;
	constexpr uint32_t AM_PERMUTE_0Y = 1;
	constexpr uint32_t AM_PERMUTE_0Z = 2;
	constexpr uint32_t AM_PERMUTE_0W = 3;
	constexpr uint32_t AM_PERMUTE_1X = 4;
	constexpr uint32_t AM_PERMUTE_1Y = 5;
	constexpr uint32_t AM_PERMUTE_1Z = 6;
	constexpr uint32_t AM_PERMUTE_1W = 7;

	constexpr uint32_t AM_SWIZZLE_X = 0;
	constexpr uint32_t AM_SWIZZLE_Y = 1;
	constexpr uint32_t AM_SWIZZLE_Z = 2;
	constexpr uint32_t AM_SWIZZLE_W = 3;

	constexpr uint32_t AM_CRMASK_CR6 = 0x000000F0;
	constexpr uint32_t AM_CRMASK_CR6TRUE = 0x00000080;
	constexpr uint32_t AM_CRMASK_CR6FALSE = 0x00000020;
	...
	AMMATRIX AMMatrixRotationRollPitchYaw(double pitch, double yaw, double roll);
	AMMATRIX AMMatrixTranslation(double x, double y, double z);
