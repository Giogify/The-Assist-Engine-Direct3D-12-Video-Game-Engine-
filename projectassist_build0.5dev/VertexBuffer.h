...
public:
	...
	VertexBuffer(ComPtr<ID3D12Device9>& pDevice, ComPtr<ID3D12GraphicsCommandList6>& pCommandList, const DSU::VertexData* vertices, const UINT64& size)  {
	...
	void createVertexBufferView(ComPtr<ID3D12GraphicsCommandList6>& pCommandList, const DSU::VertexData* vertices, const UINT64& size) noexcept {
